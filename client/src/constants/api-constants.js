...
export const ALL_CLASSES_FOR_HOME_PAGE = `${CLASSES_PATH}/display/home/all`;
...
export const FIND_CLASS_FOR_BOOKING_PAGE_PREFIX = `${CLASSES_PATH}/display/booking/class`;
