...
class ConfirmationDetails extends React.Component {
    ...
    async componentDidMount() {
        const { bookingDetails, classData } = await verifyBookingSuccess();
        if (!bookingDetails) {
            history.push('/');
            return
        }
    ...
    render() {
        const { bookingDetails, classData } = this.state;
        return (
            <>
                <Loader show={bookingDetails === null} />
                {
                    bookingDetails === null
                        ?
                        <></>
                        ...
                        bookingDetails === false
                            ?
                            <h5 className='text-danger'>Error fetching booking details, please contact customer service to make sure your class was placed</h5>
                            :
                            <>
