...
const findClassFilteredForDisplay = require('./controllers/find_class_filtered_for_display');
const allClassesFilteredForDisplay = require('./controllers/all_classes_filtered_for_display');
...
classesRouter.get('/display/class/:classId', wait(findClassFilteredForDisplay));
classesRouter.get('/display/all', wait(allClassesFilteredForDisplay));
